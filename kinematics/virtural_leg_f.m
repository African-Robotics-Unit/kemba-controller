...
r = 1.0./t22;
if nargout > 1
    dr = dl_ps.*t7.*t14.*t17.*t22.*5.7112e-2;
end
if nargout > 2
    phi = theta_b+theta_m+asin(t17.*t22.*(5.9e+1./2.5e+2));
end
if nargout > 3
    dphi = dtheta_b+dtheta_m+dl_ps.*(t7.*t14.*t16.*t22.*(5.9e+1./2.5e+2)-t7.*t14.*t18.*t22.^3.*1.3478432e-2).*1.0./sqrt((t18.*5.5696e-2)./(t19-1.1426e-1)+1.0);
end
